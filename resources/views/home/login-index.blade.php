...
>>>>>>> 67b5669068c6150229d07afd759cb163e7c3f8e4
        ...
        <div style="margin-top: 15px;"><a href=""><img src="{{url('home/image/new-title1.jpg')}}" alt=""></a></div>
        <div class="ad1">
            <p style="text-align: left;"><b>微博头条</b></p>
            @foreach($news as $new)
            <p class="new-content"><a href="{{url('home/new-detail/'.$new->id)}}">#{{$new->title}}#</a></p>
            @endforeach
        </div>
        <div class="ad2">
            <img src="{{url('home/image/hot1.png')}}" alt="">
        </div>
        <div class="ad3"></div>
        <div style="margin-top: 10px"><img src="{{url('home/image/title-r2.png')}}" alt=""></div>
    </div>
    <script>
