...
@section('content')
    <div class="power_title">
        <ul>
            ...
            <li class="li_power">广告修改</li>
        </ul>
    </div>
    <div class="power_title">
        <ul>
            <li class="li_power2"><a href="{{url('admin/advert-list')}}">广告信息列表</a></li>
        ...
        <table class="table-bordered">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <tr>
                    <td><b>当前图片</b>:    </td>
                    @foreach($result as $v)
                        <td><img src="{{url($v->icon)}}" alt="" style="width: 100px;" class="img-circle"></td>
                    @endforeach
                </tr>
                <tr>
                    <td><b>图片</b>:   </td>
                    <td><b><input type="file" class="form-control" name="icon"></b></td>
                </tr>
                <tr>
                    <td><b>格式</b>:  </td>
                ...
                <tr>
                    <td><b>状态</b></td>
                    <td>
                        <lable><input type="radio" name="status" value="1">上架</lable>
                        <lable><input type="radio" name="status" value="2">下架</lable>
                    </td>
                </tr>
