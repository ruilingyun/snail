    ...
    <div class="permissionadd_table">
        <table class="table-bordered">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <tr>
                    <td><b>图片</b>: </td>
                    <td><input type="file" name="photos" class="form-control" placeholder="Role name" ></td>
                </tr>
                <tr>
                    <td><b>类型</b>:   </td>
                    <td><select class="add_select" name="goodstype_id">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('admin/goods-list')}}" class="btn btn-primary">返回</a>
                    </td>
                </tr>
            </form>
        </table>
