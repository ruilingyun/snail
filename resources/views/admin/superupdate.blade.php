...
@section('content')
    <div class="power_title">
        <ul>
            ...
            <li class="li_power"><a href="{{url('admin/super-list')}}">用户管理=></a></li>
            <li class="li_power">修改用户</li>
        </ul>
    </div>
    <div class="power_title">
        <ul>
            <li class="li_power2"><a href="{{url('admin/super-list')}}">用户列表</a></li>
            ...
            <form action="" method="post">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{url('admin/super-list')}}" class="btn btn-primary">返回</a>
                    </td>
                </tr>
            </form>
        </table>
