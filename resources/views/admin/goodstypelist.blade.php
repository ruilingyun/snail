...
@section('content')
    ...
    <div class="power_title">
        <ul>
            <li class="li_power2"><a href="{{url('admin/goodstype-add')}}">新增类别</a></li>
        ...
        <table class="table table-bordered">
            ...
            @foreach($result as $type)
                <tr>
                    ...
                    <td>{{$type->name}}</td>
                    <td>
                        <a href="goodstype-update/{{$type->id}}" class="btn btn-default">修改</a>
                        <a href="goodstype-delete/{{$type->id}}" class="btn btn-danger">删除</a>
                    </td>
                </tr>
            @endforeach
        </table>
